...
const AboutPage: FC = () => {
    return (
        <div className='about-page' style={{ marginTop: '1rem' }}>
            ...
            <div className='container' style={{ marginTop: '2rem' }}>
                <p>
                    Implementing this process is very simple. We make use of two APIs. The first, is a <a className="about-links" target="_blank" href="https://rapidapi.com/okami4kak/api/scrapingant"> Web Scraper API </a>. We validate the Medium article by first checking to see if it is not paywalled. 
                ...
                <p style={{ marginTop: '1rem', paddingBottom: '1rem' }}>
                    The second API is <a className='about-links' target="_blank" href="https://platform.openai.com/docs/guides/text-to-speech"> OpenAI's TTS API</a> which seamlessly translates text to speech based on a voice the user requests. 
            ...
            <div className='container' style={{ marginTop: '2rem' }}>
                <p>
                    For more information on implementation and additional explanation, please visit the official <a className='about-links' target="_blank" href="https://github.com/CodingAbdullah/Medium-Article-Scraper"> code repository</a> for the application.
                </p>
                <Link to="/">
